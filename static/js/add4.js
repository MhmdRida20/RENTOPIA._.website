function openAddElementPage4() {
  var form = document.createElement("form");
  form.className = "added_form";
  form.action = "/insert_apartment";
  form.method = "POST";
  ...
  var innerHTML = `
    ...
    <div>
      <div class="info">
        ...
        <input type="text" placeholder="Bathroom" name="bathroom" id="bathroomInput"> 
        
        <input type="text" placeholder="bedroom" name="bedroom" id="bedroomInput"> 
        
        <input type="text" placeholder="floor" name="floor" id="floorInput"> 
...
document.addEventListener("DOMContentLoaded", function () {
  document.getElementById("newi").addEventListener("click", openAddElementPage4);
});
